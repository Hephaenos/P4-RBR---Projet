...
/**
* \fn int lo_test_pseudo(int reste_joueur, joueur_t tab[], int nb_bloquante, int place_joueur)
* \brief  Permet au  joueur de choisir le pseudo qui lui sera attribué
