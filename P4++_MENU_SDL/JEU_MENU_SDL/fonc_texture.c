...
* \brief Transforme du image en format texture pour pouvoir l'afficher dans la fenêtre SDL
...
/**
* \fn SDL_Texture *tex_text(char* font,int size, char* s, SDL_Color color, SDL_Renderer* renderer)
