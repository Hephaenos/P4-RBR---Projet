...
int main(int argc, char** argv)
{
	...
	SDL_Color couleurOrange= {223, 109, 20};
	...
	texte = TTF_RenderUTF8_Blended(police, "Puissance 4", couleurNoire);
	if(!texte){
    ...
    txtDestRect.x = 400, txtDestRect.y = 10;
	SDL_QueryTexture(texte_tex, NULL, NULL, &(txtDestRect.w), &(txtDestRect.h));

	// load sample.png into image
	SDL_RWops *rwop=SDL_RWFromFile("grille_p4.png", "rb");
